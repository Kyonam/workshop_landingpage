  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6 bg-zinc-950">
      <div className="glass p-10 md:p-16 rounded-[3rem] max-w-xl w-full text-center">
        ...
        <h1 className="text-3xl md:text-5xl font-black mb-6">결제가 중단되었습니다</h1>
        <div className="space-y-4 text-zinc-400 text-lg md:text-xl leading-relaxed mb-12">
          <p className="font-bold text-white">결제 진행이 취소되었습니다.</p>
          <p className="text-sm">
            요청 처리 중 오류가 발생했거나 결제를 직접 취소하셨을 수 있습니다. <br />
            다시 시도하시거나 문제가 지속되면 고객센터로 문의해주세요.
          </p>
        </div>
